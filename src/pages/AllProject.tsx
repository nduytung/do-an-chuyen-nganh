...
const AllProject: React.FC<{}> = () => {
    ...
    return <div className="pt-18  w-full flex flex-col ">
        ...
        <div className=" w-full bg-[#eff5f3] xl:flex-col lg:flex-col pl-10 pt-10 pb-16 xl:flex lg:flex iphone:flex-col iphone:flex ">
            ...
            <PrimaryButton nameBtn="Projects Explore" type="DEFAULT" classname="w-fit  justify-self-end xl:mr-20 lg:mr-20 iphone:mt-10 xl:mt-10 lg:mt-10"/>
            <div className="grid iphone:grid-cols-1 xl:grid-cols-3 lg:grid-cols-2 gap-6 mt-10" >
              {CATEGORY.map((item) => {
                return (
                  <Category
                    title={item.title}
