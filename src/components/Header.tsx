...
const Header = () => {
  ...
  return <div className="header w-full h-16 bg-white  shadow-2xl  fixed z-[100] flex flex-row">
    ...
    <PrimaryButton type="DEFAULT" classname="my-auto ml-1" nameBtn="Add a Project"/>
    
    {/* Search Button */}
    <div className=" ml-8 bg-slate-200 rounded-full my-auto p-2.5 align-middle hover:cursor-pointer hover:opacity-70">
      <a>
