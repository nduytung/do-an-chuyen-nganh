...
const Header = () => {
  ...
  return <div className="laptop:w-full py-2 bg-white  shadow-2xl  fixed z-[100] flex flex-row iphone:h-20 iphone:w-[414px] iphone:items-center">
    ...
    <a onClick={()=>setOpenNav(true)} className="iphone:absolute iphone:right-14 laptop:invisible iphone:hover:cursor-pointer rounded border p-1">
    ...
    <ul className=" ml-16 w-6/12 mr-12 iphone:invisible laptop:visible my-auto flex flex-row">
      ...
      <li className="  no-underline px-5 relative group hover:cursor-pointer justify-center align-middle ">
        ...
        <ul className="absolute mt-0.5 w-44 h-[164px] bg-white shadow-xl rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible duration-300 max-h-0 group-hover:max-h-48 ">
          <li><a className=" hover:text-green-700 hover:font-semibold block pl-3 leading-10 border-b text-sm tracking-widest " href="/about">About</a></li>
