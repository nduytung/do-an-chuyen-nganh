  ...
  return <div className="w-full flex bg-[#282b39] justify-center items-center pt-20 pb-10 px-10 flex-col">
    ...
    <div className="bg-transparent laptop:flex-row flex laptop:w-full iphone:w-full iphone:flex-col">
      ...
      <div className="flex-[3_1_0%] bg-transparent">
        <div className="text-white text-2xl laptop:ml-10 iphone:ml-4 mt-4 font-semibold">Our Projects</div>
      ...
      <div className="flex-[3_1_0%] bg-transparent">
        <div className="text-white text-2xl laptop:ml-10 iphone:ml-4 mt-4 font-semibold">Company</div>
        <div className="mt-10 ml-10 space-y-2.5 flex-col flex text-slate-100">
