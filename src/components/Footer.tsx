  ...
  return <div className="w-full flex bg-[#282b39] justify-center items-center pt-20 pb-10 px-10 flex-col">
    ...
    <div className="bg-transparent flex xl:flex-row lg:flex-row  iphone:flex-col lg:w-full  xl:w-full iphone:w-full ">
      ...
      <div className="flex-[3_1_0%] bg-transparent">
        <div className="text-white text-2xl xl:ml-10 iphone:ml-4 mt-4 font-semibold">Our Projects</div>
      ...
      <div className="flex-[3_1_0%] bg-transparent">
        <div className="text-white text-2xl xl:ml-10 iphone:ml-4 mt-4 font-semibold">Company</div>
        <div className="mt-10 ml-10 space-y-2.5 flex-col flex text-slate-100">
